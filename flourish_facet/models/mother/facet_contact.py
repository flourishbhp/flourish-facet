...
from ...choices import CONTACT_TYPE, CALL_REASON, REASONS_FOR_RESCHEDULING
...
class FacetCaregiverContact(NonUniqueSubjectIdentifierFieldMixin, BaseUuidModel):
    ...
    class Meta:
        ...
        verbose_name = 'Facet Caregiver Contact'
